...
import com.example.app.contract.LoginContract
import com.example.app.databinding.ActivityLoginBinding
import com.example.app.presenters.LoginPresenter
...
class LoginActivity : AppCompatActivity(), LoginContract.View {
    ...
    override fun navigateToLoginViaAccount() {
        val intent = Intent(this, LoginViaAccountActivity::class.java)
