...
class ListSelectDishAdapter(
    private val context: Context,
    private val dishes: List<DishSelect>
) : RecyclerView.Adapter<ListSelectDishAdapter.DishSelectViewHolder>()
{
    var onClickButtonAdd: ((DishSelect, Int) -> Unit)? = null
    var onClickButtonSubtract: ((DishSelect, Int) -> Unit)? = null
    var onClickButtonRemove: ((DishSelect, Int) -> Unit)? = null
    var onClickOpenCalculator: ((DishSelect, Int) -> Unit)? = null
    var onClickItem:((DishSelect, Int) -> Unit)? = null
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_select_dish,null)
    ...
    override fun onBindViewHolder(
        ...
        holder.dishColor.backgroundTintList = ColorStateList.valueOf(dishSelect.dish.color.toColorInt())
        holder.dishImage.setImageDrawable(ImageHelper.getDrawableImageFromAssets(context,dishSelect.dish.image))
        holder.dishName.text = dishSelect.dish.name
        holder.dishPrice.text = FormatDisplay.formatNumber(dishSelect.dish.price.toString())
        holder.dishOrderQuantity.text = dishSelect.quantity.toString()
