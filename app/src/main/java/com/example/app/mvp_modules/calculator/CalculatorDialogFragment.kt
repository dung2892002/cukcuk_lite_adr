...
class CalculatorDialogFragment : DialogFragment(), CalculatorContract.View {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val view = layoutInflater.inflate(R.layout.fragment_calculator_dialog, null)
        ...
        buttonHandleCalculator = view.findViewById(R.id.btnHandleCalculator)
        ...
        buttonHandleCalculator.setOnClickListener {
    ...
    override fun onCalculateState(state: Boolean) {
        if (!state) {
            ...
            buttonHandleCalculator.visibility = View.GONE
        } else {
            buttonSubmit.visibility = View.GONE
            buttonHandleCalculator.visibility = View.VISIBLE
        }
    }
